...
public class RegEntry<B extends BlockEntity, G extends ScreenHandler, S extends HandledScreen<G>, R extends Recipe<?>> {
    ...
    public RegEntry(final Identifier id, final Block BLOCK, final BlockEntityType<B> BLOCK_ENTITY_TYPE, final Item ITEM, final ItemGroup ITEM_GROUP, final ScreenHandlerType<G> GUI, final Factory<G, S> SCREEN, final RecipeType<R> RECIPE_TYPE, final RecipeSerializer<R> RECIPE_SERIALIZER) {
        ...
        this.ITEM_GROUP = ITEM_GROUP == null ? null : ITEM_GROUP;
