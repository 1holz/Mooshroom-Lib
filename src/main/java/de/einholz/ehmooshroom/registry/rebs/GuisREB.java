...
public interface GuisREB<B extends BlockEntity, G extends ScreenHandler, S extends HandledScreen<G>, R extends Recipe<?>> {
    abstract RegEntryBuilder<B, G, S, R> withGuiRaw(
            Function<RegEntryBuilder<B, G, S, R>, ScreenHandlerType<G>> guiFunc);
    ...
    default <T extends ScreenHandlerType<G>> RegEntryBuilder<B, G, S, R> withGuiBuild(GuiFactory<G, T> factory,
            ExtendedClientHandlerFactory<G> clientHandlerFactory) {
